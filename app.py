...
def extract_tables(pdf_path):
    ...
    # Try Camelot first for both text-based and image-based PDFs
    camelot_tables = camelot.read_pdf(pdf_path, pages='all', flavor='stream')
    for table in camelot_tables:
        tables.append(table.df)
    
    # If Camelot didn't find any tables, try OCR approach
    if not tables:
            ...
            if '/XObject' in page['/Resources']:
                ...
                for obj in xObject:
                    if xObject[obj]['/Subtype'] == '/Image':
                        ...
                        # Use LangChain to process the OCR text and extract tables
                        ...
                        # Convert the extracted table string to DataFrame
